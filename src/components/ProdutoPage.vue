<template>
  ...
  <div class="product-details" v-if="produto">
    ...
    <div class="product-container">
      ...
      <div class="product-info">
        ...
        <div class="additional-details">
          ...
          <ul>
            <li><strong>Detalhes do Produto:</strong> {{ produto.detalhes }}</li>
    ...
    <BenefitsSection :title="produto.title" /> <!-- Componente BenefitsSection -->
    <!-- Galeria de Imagens -->
    <ProductGallery :productId="produto.id" /> <!-- Componente ProductGallery -->
  </div>
  <Footer />
</template>
