            ...
            <article class="project-card">
                <div class="project-thumbnail">
                    ...
                    <div class="project-overlay">
                        <a href="#" class="view-project" @click.prevent="openOverlay(1)">Ver Projeto</a>
                    </div>
                </div>
                <div class="project-info">
                    <span class="project-category">Aplicativos</span>
                    <h3>Tech App - Gestão de Tarefas</h3>
                    <p>Aplicativo mobile para gestão de tarefas e projetos com integração em tempo real e análise de produtividade.</p>
